...
public sealed class CreateHabitDtoValidator : AbstractValidator<CreateHabitDto>
{
    ...
    private static bool IsTargetUnitCompatibleWithType(HabityType type, string unit)
    {
        ...
        return type switch
        {
            ...
            HabityType.Binary => AllowedUnitsForBinaryHabits.Contains(normalizedUnit),
            // Measurable habits can use any of allowed units
            HabityType.Measurable => AllowedUnits.Contains(normalizedUnit),
